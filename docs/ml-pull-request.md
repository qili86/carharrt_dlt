...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/carharrt_dlt-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-5402441514264631.11.azuredatabricks.net/explore/data/models/staging/carharrt_dlt/carharrt_dlt-model)
* [Prod model in UC](https://adb-5402441514264631.11.azuredatabricks.net/explore/data/models/prod/carharrt_dlt/carharrt_dlt-model)
. 
