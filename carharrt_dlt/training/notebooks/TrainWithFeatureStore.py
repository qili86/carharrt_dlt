...
##################################################################################
# Model Training Notebook using Databricks Feature Store pr7
#
...
dbutils.widgets.text(
    "model_name", "dev.carharrt_dlt.carharrt_dlt-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.carharrt_dlt.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.carharrt_dlt.trip_dropoff_features",
